    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#ativos">
                        <i class="fas fa-layer-group"></i>
                        <p>Gestão de Ativos</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse" id="ativos">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="{{ route('ativos.index') }}">
                                    <span class="sub-item">Cadastrar Ativos</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="nav-item">
                    <a data-bs-toggle="collapse" href="#inventario">
                        <i class="fas fa-layer-group"></i>
                        <p>Gestão de Inventario</p>
                        <span class="caret"></span>
                    </a>
                    <div class="collapse" id="inventario">
                        <ul class="nav nav-collapse">
                            <li>
                                <a href="{{ url('/physical_inventories') }}">
                                    <span class="sub-item">Inventario</span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('asset_movements.index') }}">
